...
$fileconnector = $mosConfig_live_site . "/mambots/editors/jtf/jscripts/tiny_mce/filemanager/browser.html?Connector=connectors/php/connector.php";
	...
	// autotypeselection
	$fbautotypeselection		= $params->def( 'fbautotypeselection', 			1 );
	...
	if ( $compressed ) {		
		$load 				= '<script type="text/javascript" src="'. $mosConfig_live_site .'/mambots/editors/jtf/jscripts/tiny_mce/tiny_mce_gzip.js"></script>';
		$load_init 			= '
		...
		$load 				= '<script type="text/javascript" src="'. $mosConfig_live_site .'/mambots/editors/jtf/jscripts/tiny_mce/tiny_mce_src.js"></script>';
		$load_init 			= '';
	}
...
return <<<EOD
	...
	function fileBrowserCallBack(field_name, url, type, win) {
		var connector = "$fileconnector";
		var enableAutoTypeSelection = $fbautotypeselection;
