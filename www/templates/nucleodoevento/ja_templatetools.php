...
function genToolMenu($jatool){
	...
	if ($jatool & 1){//show screen tools
		?>
	    <a href="#Narrow" onclick="return false;"><img title="800x600" src="<?php echo $ja_template_path;?>/images/<?php echo $ja_color?>/user-screen1<?php echo ( ($ja_width=="narrow") ? "-hilite" : "" ) ?>.gif" alt="Resolução 800x600" id="ja-tool-narrow" onclick="changeToolHilite(curtool, this);curtool=this;setScreenType('narrow');" /></a>
	    <a href="#Wide" onclick="return false;"><img title="1024x768" src="<?php echo $ja_template_path;?>/images/<?php echo $ja_color?>/user-screen2<?php echo ( ($ja_width=="wide") ? "-hilite" : "" ) ?>.gif" alt="Resolução 1024x768" id="ja-tool-wide" onclick="changeToolHilite(curtool, this);curtool=this;setScreenType('wide');" /></a>
<?php } 
...
?>
      <a href="#Increase" onclick="return false;"><img title="Aumentar tamanho da fonte" src="<?php echo $ja_template_path;?>/images/<?php echo $ja_color?>/user-increase.gif" alt="Aumentar tamanho da fonte" id="ja-tool-increase" onclick="changeFontSize(1); return false;" /></a>
	    ...
	    <a href="#Default" onclick="return false;"><img title="Tamanho padrão da fonte" src="<?php echo $ja_template_path;?>/images/<?php echo $ja_color?>/user-reset.gif" alt="Tamanho padrão da fonte" id="ja-tool-reset" onclick="revertStyles(<?php echo $ja_font_size_default;?>); return false;" /></a>
		<?php
	}
