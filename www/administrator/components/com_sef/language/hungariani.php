...
DEFINE('_COM_SEF_DISABLED',"<p class='error'>MEGJEGYZÉS: A Joomla/Mambo keresõbarát támogatása jelenleg letiltott. Ha használni kívánod a keresõbarát webcímeket, akkor engedélyezd az <a href='"
