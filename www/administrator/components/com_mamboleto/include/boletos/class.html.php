...
class Boleto_HTML extends Boleto_Comum
{
    ...
    function _geraDadosBoleto()
    {
        ...
        $barra = '<img src='.BOLETO_URL.'include/codbarras.php?cod='.$this->banco["codigo_barras"].'&altura=65&espmin=1>';
        ...
        //$this->_escreveTexto("SACADOR", 'NOME DO SACADOR');
        // Aceite
        $this->_escreveTexto("ACT", "");
        // data do processamento
//original        $this->_escreveTexto("DDOC", $this->_inicializar($this->opcoes["data_processamento"], ""));
        ...
        // barra de códigos
//original        $this->_escreveTexto("BAR", $this->barra);
        $this->_escreveTexto("BAR2", $this->barra);
