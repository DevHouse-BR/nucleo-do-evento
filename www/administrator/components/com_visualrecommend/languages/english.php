...
// COMMON
DEFINE("_VRECOMMEND_FILTER","Filter");
DEFINE("_VRECOMMEND_CLOSE","Close");
DEFINE("_VRECOMMEND_BACK","Back");
DEFINE("_VRECOMMEND_POINTS","Points");
DEFINE("_VRECOMMEND_REGISTERED","Registered");
DEFINE("_VRECOMMEND_GUEST","Guest");

// ADMIN ABOUT
DEFINE("_VRECOMMEND_ABOUT","About");

// FRONT-END
DEFINE("_VRECOMMEND_RECOMMEND","Recommend this article...");
DEFINE("_VRECOMMEND_RECOMMEND_FORM","Send this article to your friends...");
DEFINE("_VRECOMMEND_YOURFRIENDNAME","Your friend's name(s)");
DEFINE("_VRECOMMEND_YOURFRIENDEMAILADRESS","Your friend's email address(es)");
DEFINE("_VRECOMMEND_YOURNAME","Your name (required)");
DEFINE("_VRECOMMEND_YOUREMAILADDRESS","Your email address (required)");
DEFINE("_VRECOMMEND_MESSAGEADDEDATYOURRECOMMEND","Message added at your recommend (optional):");
DEFINE("_VRECOMMEND_SUBMIT","Submit");
DEFINE("_VRECOMMEND_ADDEMAIL","Add email(s)");
DEFINE("_VRECOMMEND_REMOVEEMAIL","Remove email(s)");
DEFINE("_VRECOMMEND_FRIENDEMAILERROR","Error on friend Email");
DEFINE("_VRECOMMEND_FRIENDNAMEERROR","Error on friend name");
DEFINE("_VRECOMMEND_NAME_ERROR","Error on your name");
DEFINE("_VRECOMMEND_ONLYREGISTERED","Only registered users can recommend an article.<br />Please login or register.");
DEFINE("_VRECOMMEND_MAXDAILYEXCEEDED","You exceeded the maximum quota of sending per day, you cannot send new messages more.");
DEFINE("_VRECOMMEND_SENDINGSRELEASED","sending(s) released. Thank you for your recommend(s)");
DEFINE("_VRECOMMEND_NOSENDINGRELEASED","No sending released. Check the emails of your friends.");
DEFINE("_VRECOMMEND_TO_REDUCE","To reduce");
DEFINE("_VRECOMMEND_GOTO_ARTICLE","Go to article");
DEFINE("_VRECOMMEND_GOTO_PROFILE","Go to profile of"); // use with Community Builder
DEFINE("_VRECOMMEND_ADD_LINK_PROFILE","add link to my profile"); // use with Community Builder
?>