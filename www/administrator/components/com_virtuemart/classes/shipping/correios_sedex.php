...
/**
*
* @version $Id: correios_sedex.php,v 1.4 24/07/2007 $
* @package VirtueMart
* @subpackage shipping
...
* @copyright (C) 2007 Fernando Soares, htt://www.fernandosoares.com.br
...
//		require_once(CLASSPATH ."shipping/".$this->classname.".cfg.php");
		...
		//setup das variáveis para Consulta Correios - SEDEX Normal
	    ...
	    $teste = implode("", file('http://www.correios.com.br/encomendas/precos/calculo.cfm?resposta=paginaCorreios&servico=40010&cepOrigem='.$Order_Pickup_Postcode.'&cepDestino='.$Order_Destination_Postcode.'&peso='.$Order_WeightKG.'&MaoPropria='.$Order_MaoPropria.'&valorDeclarado='. $order_total .'&avisoRecebimento='.$Order_Aviso));
		...
		$APcharge = floatval(str_replace("," , ".", substr($valor,3)));
			...
			$shipping_rate_id = urlencode( $this->classname."|Correios Brasil|SEDEX Normal|".$Total_Shipping_Handling);

			$html .= "\n<input type=\"radio\" name=\"shipping_rate_id\" id=\"correios_sedex\" checked=\"checked\" value=\"$shipping_rate_id\" />\n";
			$html .= "<label for=\"correios_sedex_shipping_rate\">Correios - SEDEX Normal&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;- ";
  ...
  */
	...
	*/
	function write_configuration( &$d ) {
		...
		"SEDEX_TAX_CLASS" => $d['SEDEX_TAX_CLASS'],"MaoPropria" => $d['MaoPropria'],"AvisoReceb" => $d['AvisoReceb'],"Ponto" => $d['Ponto']
		);
		$config = "<?php\n";
