...
/**
*
* @version $Id: correios_encomenda.php,v 1.4 24/07/2007 $
* @package VirtueMart
* @subpackage shipping
...
class correios_encomenda {

	var $classname = "correios_encomenda";
...
//		require_once(CLASSPATH ."shipping/".$this->classname.".cfg.php");
	...
	$Opt2 = "";
		...
		$APcharge = floatval(str_replace("," , ".", substr($valor,3)));
			...
			$shipping_rate_id = urlencode( $this->classname."|Correios Brasil|Encomenda Normal|".$Total_Shipping_Handling);

			$html .= "\n<input type=\"radio\" name=\"shipping_rate_id\" id=\"correios_encomenda\" checked=\"checked\" value=\"$shipping_rate_id\" />\n";
			$html .= "<label for=\"Correios_encomenda_shipping_rate\">Correios - Encomenda Normal&nbsp;&nbsp;&nbsp;&nbsp;- ";
...
//Mostra o logo dos correios se este estiver disponível no site dos correios
	...
	$logo_correios = "http://www.correios.com.br/images/correios.gif"; //Caminho para o logo dos Correios
