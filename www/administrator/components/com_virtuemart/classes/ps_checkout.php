...
/**
*
* @version $Id: ps_checkout.php 867 2007-06-20 18:41:06Z soeren_nb $
* @package VirtueMart
* @subpackage classes
...
class ps_checkout {
	...
	function show_checkout_bar($steps_to_do, $step_msg, $step_count, $highlighted_step) {
		...
		echo '<br>
		<table style="background: url('. IMAGEURL .'ps_image/checkout'. $step_count.'_'.$highlighted_step .'.png) right; background-repeat: no-repeat; background-position:top; height:100px;text-align:center;" border="0" cellspacing="0" cellpadding="0">
          <tr>';
