...
define( 'SECUREURL', 'https://nucleodoevento.websiteseguro.com/' );
...
define('PSHOP_OFFLINE_MESSAGE', '<h2>Nossa loja está atualmente fechada para manutenção.</h2> Por favor, volte mais tarde.');
...
define('VM_ONCHECKOUT_LEGALINFO_SHORTTEXT', '<h5>Política de devoluções</h5>
...
define('VM_ONCHECKOUT_LEGALINFO_LINK', '1');
...
define('DOWNLOADROOT', '/home/restricted/home/nucleodoevento/public_html/');
...
define('CHECK_STOCK', '');
define('ENCODE_KEY', 'nucleo_do_evento');
define('NO_SHIPPING', '');
define('NO_SHIPTO', '');
...
$PSHOP_SHIPPING_MODULES[0] = "correios_encomenda";
$PSHOP_SHIPPING_MODULES[1] = "correios_sedex";
?>