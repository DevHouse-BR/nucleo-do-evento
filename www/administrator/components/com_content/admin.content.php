...
function editContent( $uid=0, $sectionid=0, $option ) {
	...
	$robots[] = mosHTML::makeOption( '-1', 'Hide robots meta tag' );
	...
	$lists['robots'] 	= mosHTML::selectList( $robots, 'params[robots]', 'class="inputbox" size="1"', 'value', 'text', $params->get ('robots') );
