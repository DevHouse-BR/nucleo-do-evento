...
/*
Note:
- The "to request a transcript" text that is displayed after a visitor
closes out the chat is located in your setup area under "Email Transcript".

- The "there are x number of requests before you" during the initial chat
request is located in the code level in file request_fmain.php
