...
<?
	...
	if ( $action == "save" )
	{
		// defunct - now it is autosave
		$sessioninfo = ServiceChat_get_ChatSessionInfo( $dbh, $sessionid ) ;
		if ( ServiceTranscripts_put_ChatTranscript( $dbh, $sessionid, $session_chat[$sid]['transcript'], $admin['userID'], $sessioninfo['screen_name'], 'email addrress', $session_chat[$sid]['deptid'], $session_chat[$sid]['aspID'], 0 ) )
			$save_success = 1 ;
	}
...
<tr>
	...
	<td valign="bottom" align="right" width="100%">
		...
		<tr>
			<td valign="bottom"><span class="smalltxt">[ <a href="JavaScript:viewit()"><? echo $LANG['CHAT_PRINTER_FRIENDLY'] ?></a> ]</td>
		</tr>
		</table>
	</td>
</tr>
