<?
	...
	*******************************************************/
	...
	if ( isset( $HTTP_GET_VARS['table'] ) ) { $table = $HTTP_GET_VARS['table'] ; }
	if ( isset( $HTTP_POST_VARS['cleanup'] ) ) { $cleanup = $HTTP_POST_VARS['cleanup'] ; }
	if ( isset( $HTTP_POST_VARS['timeframe'] ) ) { $timeframe = $HTTP_POST_VARS['timeframe'] ; }
