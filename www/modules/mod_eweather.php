...
function showWeather(&$weather) {
  ...
  $content = "<table border=\"0\" cellspacing=\"0\" style=\"border-collapse: collapse;\" align=\"center\" width=\"99%\">\n"
            ...
            ."  <tr>\n"
            ."    <td>\n"
            ."      <div align=\"center\" valign=\"middle\"><img src=\"".$mosConfig_live_site."/components/com_eweather/images/".$weatherIconsStyle."/small/".$weather->cc_icon."32.png\" alt=\"\" border=\"0\"></div>\n"
            ."    </td>\n"
            ."    <td valign=\"top\">\n"
            ...
            ."    </td>\n"
            ."    <td>\n"
            ."      <div align=\"center\"><img src=\"".$mosConfig_live_site."/components/com_eweather/images/".$weatherIconsStyle."/winddirs_small/wind_E".$weather->cc_windtext.".gif\" alt=\"\" border=\"0\"></div>\n"
            ...
            ."      <input type=\"button\" value=\""._W_MOD_BUTTON."\" class=\"button\" onClick=\"self.location = 'index.php?option=com_eweather&Itemid=".$myItemID."';\">\n"
            ."    </td>\n"
            ."  </tr>\n"
            ."  <tr>\n"
