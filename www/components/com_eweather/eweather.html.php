...
class HTML_weather {
  ...
  function displayForecast(&$weather, $weatherIconsStyle, $date_format){
    ...
    $content.= "          <td>\n"
              ...
              ."            <div align=\"center\"><img src=\"".$mosConfig_live_site."/components/com_eweather/images/".$weatherIconsStyle."/small/32".$weather->dayf_forecasts[$x]->day_d_icon.".png\" border=\"0\" alt=\"\" /><br /></div>\n"
              ."          </td>\n"
              ."          <td style=\"border-right: 1px solid #CCCCCC; border-bottom: 1px solid #CCCCCC;\">\n"
              ."            <div align=\"center\"><img src=\"".$mosConfig_live_site."/components/com_eweather/images/".$weatherIconsStyle."/small/32".$weather->dayf_forecasts[$x]->day_n_icon.".png\" border=\"0\" alt=\"\" /><br /></div>\n"
              ."          </td>\n"
              ."        </tr>\n"
              ."        <tr>\n"
              ...
              ."        <tr>\n"
              ."          <td style=\"border-left: 1px solid #CCCCCC; border-right: 1px solid #CCCCCC; border-bottom: 1px solid #CCCCCC;\">\n"
              ."            <div align=\"center\">"._W_FORECAST_TEMP_MAX.": ".$weather->dayf_forecasts[$x]->day_temp_max."20°".$weather->h_temp."<br /></div>\n"
              ."          </td>\n"
              ."          <td style=\"border-right: 1px solid #CCCCCC; border-bottom: 1px solid #CCCCCC;\">\n"
              ."            <div align=\"center\">"._W_FORECAST_TEMP_MIN.": ".$weather->dayf_forecasts[$x]->day_temp_min."26°".$weather->h_temp."<br /></div>\n"
              ."          </td>\n"
              ."        </tr>\n"
              ."        <tr>\n"
              ."          <td style=\"border-left: 1px solid #CCCCCC; border-right: 1px solid #CCCCCC;\" colspan=\"2\">\n"
              ...
              ."        <tr>\n"
              ."          <td style=\"border-left: 1px solid #CCCCCC; border-right: 1px solid #CCCCCC; border-bottom: 1px solid #CCCCCC;\">\n"
              ."            <div align=\"center\">".$weather->dayf_forecasts[$x]->day_d_precipitation."5%<br /></div>\n"
              ."          </td>\n"
              ."          <td style=\"border-right: 1px solid #CCCCCC; border-bottom: 1px solid #CCCCCC;\">\n"
              ."            <div align=\"center\">".$weather->dayf_forecasts[$x]->day_n_precipitation."9%<br /></div>\n"
              ."          </td>\n"
              ."        </tr>\n"
              ."      </table>\n";
              if ($x == 4) {
  ...
  function displayDetailForecast(&$weather, $weatherIconsStyle, $lastUpdate, $metric_v, $metric_t, $date_format){
    ...
    $content = "<table width=\"98%\" border=\"0\" cellspacing=\"0\" cellpadding=\"3\" align=\"center\" summary=\"\">\n"
              ...
              ."                </td>\n"
              ."                <td>\n"
              ."                  <div style=\"font-size: 11px; font-weight: normal; color: #000000; text-align: right;\">80".$weather->day_d_windspeed."&nbsp;".$metric_v."</div>\n"
              ."                </td>\n"
              ."              </tr>\n"
              ."              <tr style=\"background: #EFEFEF;\">\n"
              ."                <td>\n"
              ...
              ."                </td>\n"
              ."                <td>\n"
              ."                  <div style=\"font-size: 11px; font-weight: normal; color: #000000; text-align: right;\">".$weather->day_d_winddirection."70°</div>\n"
              ."                </td>\n"
              ."              </tr>\n"
              ."              <tr style=\"background: #DFDFDF;\">\n"
              ."                <td>\n"
              ...
              ."                      </td>\n"
              ."                      <td width=\"50%\" height=\"140\">\n"
              ."                        <div align=\"center\"><img src=\"".$mosConfig_live_site."/components/com_eweather/images/".$weatherIconsStyle."/winddirs/wind_E".$weather->day_d_windtext.".gif\" border=\"0\" alt=\"\" /><br /></div>\n"
              ."                      </td>\n"
              ."                    </tr>\n"
              ."                  </table>\n"
              ."                </td>\n"
              ...
              ."                    <tr>\n"
              ."                      <td width=\"50%\" height=\"140\">\n"
              ."                        <div align=\"center\"><img src=\"".$mosConfig_live_site."/components/com_eweather/images/".$weatherIconsStyle."/large/32".$weather->day_n_icon.".png\" border=\"0\" alt=\"\" /><br /></div>\n"
              ."                      </td>\n"
              ."                      <td width=\"50%\" height=\"140\" valign=\"middle\">\n"
